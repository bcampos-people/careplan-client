...
@NgModule({
  ...
  declarations: [CareplanComponent, NocareplanComponent, IssuesComponent],
  providers: [AllergyService, CareplanService, CommunicationService, DetectedIssueService, GoalService, LoginService,
    PatientService, ValuesetService]
})
